...
@section('content')
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-12 col-sm-5">
                            <div class="slider-single-img slider-animated-1">
                                <img class="animated" src="{{ asset('img/slider/slider-single-img.png') }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-5 col-12">
                            <div class="slider-single-img slider-animated-1">
                                <img class="animated" src="{{ asset('img/slider/slider-single-img-2.png') }}"
                                    alt="">
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="product-wrapper mb-10">
                            <div class="product-img">
                                <a href="{{route('pet-shop/product-details',['id'=>$randProduct->id])}}">
                                    <img src="{{ asset('storage/' . $randProduct->img) }}" alt="">
                                </a>
    ...
    <div class="testimonial-area pt-90 pb-70 bg-img"
        style="background-image:url({{ asset('img/banner/banner-1.jpg') }});">
        <div class="container">
            <div class="row">
                    ...
                    <div class="testimonial-wrap">
                        <div class="testimonial-text-slider text-center">
                            <div class="sin-testiText">
                                <p>Lorem ipsum dolor sit amet, co adipisicing elit, sed do eiusmod tempor incididunt ut
                            ...
                            <div class="sin-testiText">
                                <p>There are many variations of passages of Lorem Ipsum available, but the majority have
                                    suffered alteration in some form, by injected humour, or amro porano ja cai tomi tai
                                    go amro porano amro porano ja cai tomi tai go .... </p>
                            </div>
                            <div class="sin-testiText">
                                <p>Lorem ipsum dolor sit amet, co adipisicing elit, sed do eiusmod tempor incididunt ut
                                    labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercita
            ...
            <div class="row">
                    ...
                    <div class="blog-wrapper mb-30 gray-bg">
                        <div class="blog-img hover-effect">
                            <a href="blog-details.html"><img alt=""
                                    src="{{ asset('img/blog/blog-1.jpg') }}"></a>
                        </div>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-wrapper mb-30 gray-bg">
                        <div class="blog-img hover-effect">
                            <a href="blog-details.html"><img alt=""
                                    src="{{ asset('img/blog/blog-2.jpg') }}"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <ul>
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="blog-wrapper mb-30 gray-bg">
                        <div class="blog-img hover-effect">
                            <a href="blog-details.html"><img alt=""
                                    src="{{ asset('img/blog/blog-3.jpg') }}"></a>
                        </div>
                        <div class="blog-content">
                            <div class="blog-meta">
                                <ul>
