                                ...
                                <ul>
                                    ...
                                    <li class="mega-menu-position"><a href="shop-page.html">Food</a>
                                        <ul class="mega-menu">
                                            ...
                                            <li>
                                                <ul>
                                                    <li><a href="shop-page.html"><img alt=""
                                                                src="{{ asset('img/banner/menu-img-4.jpg') }}"></a>
                                                    </li>
                                                </ul>
                                            </li>
                                        </ul>
                    ...
                    <div class="col-xl-3 col-lg-3 col-md-6 col-sm-6">
                        <div class="footer-widget mb-30">
                            <div class="footer-info-wrapper">
                                ...
                                <p>Lorem ipsum dolor sit amet, co adipisi elit, sed eiusmod tempor incididunt ut labore
                                    et dolore</p>
                                        ...
                                        <form action="#" method="post" id="mc-embedded-subscribe-form"
                                            ...
                                            <div id="mc_embed_signup_scroll" class="mc-form">
                                                ...
                                                <div class="mc-news" aria-hidden="true"><input type="text"
                                                        ...
                                                        value=""></div>
                                                <div class="clear"><input type="submit" value="SEND"
