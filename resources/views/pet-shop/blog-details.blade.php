                        ...
                        <div class="blog-details-wrapper res-mrg-top">
                            <div class="single-blog-wrapper">
                                <div class="blog-img mb-30">
                                    <img src="{{asset('/img/blog/blog-details.jpg')}}" alt="">
                                </div>
                                ...
                                <div class="dec-img-wrapper">
                                    <div class="row">
                                        <div class="col-md-6 col-sm-6">
                                            <div class="dec-img">
                                                <img src="{{asset('/img/blog/blog-dec-img1.jpg')}}" alt="">
                                            </div>
                                        </div>
                                        <div class="col-md-6 col-sm-6">
                                            <div class="dec-img dec-mrg res-mrg-top-2">
                                                <img src="{{asset('/img/blog/blog-dec-img2.jpg')}}" alt="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="blog-comment-wrapper mt-55">
                                ...
                                <div class="single-comment-wrapper mt-35">
                                    <div class="blog-comment-img">
                                        <img src="{{asset('/img/blog/blog-comment1.png')}}" alt="">
                                    </div>
                                ...
                                <div class="single-comment-wrapper mt-50 ml-125">
                                    <div class="blog-comment-img">
                                        <img src="{{asset('/img/blog/blog-comment2.png')}}" alt="">
                                    </div>
                                    <div class="blog-comment-content">
                                        <h4>Anthony Stephens</h4>
                                        <span>October 14, 2018 </span>
